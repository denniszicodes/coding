...
const fs = require("fs")
const file = fs.readFileSync("inputDay1.txt").toString()
const numbers = file.split(/\n/g).map(num => {return parseInt(num)})
...
console.log(`The entries are '${twoEntries[0]}' and '${twoEntries[1]}'. The result is ${twoMultiplied}`)
